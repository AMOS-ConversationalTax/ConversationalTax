...
import { DeleteContractIntentHandler } from '../handlers/handler.deletecontract';
 ...
 */
@Injectable()
export class DeleteContractFactory implements IIntentFactory {

    constructor(private deleteContractIntentHandler: DeleteContractIntentHandler) {
    }
    ...
    createIntentHandler(): IntentHandler {
        return this.deleteContractIntentHandler;
    }
    ...
    appliesTo(intentID: string): boolean {
        return (intentID === IntentConfig.INTENT_PREFIX + DIALOGFLOW_INTENT_IDS.Contract_Delete);
    }
}